...
class Quiz extends React.Component {
  ...
  handleCorrectPush = () => {
    ...
    return total === totalQuestions && quizComplete
      ? this.showModal()
      : this.props.dispatch(
          addCorrect(currQuestionIndex, correctAnswers, currVisibleQuestionIndex),
        );
  };
  ...
  handleIncorrectPush = () => {
    ...
    return total === totalQuestions && quizComplete
      ...
      : this.props.dispatch(
          addIncorrect(currQuestionIndex, incorrectAnswers, currVisibleQuestionIndex),
        );
  };
  ...
  resultsDecision = ({ decision }) => {
    ...
    //clearLocalNotifications().then(setLocalNotifications()); I don't have notis in RN
  };
